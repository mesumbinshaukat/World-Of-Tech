...
<body>
  <div class="container">
    ...
    <div class="items">
            <a class="text-decoration-none text-dark" href="blogdetails.php?id='<?php echo $blogs_cards['id']?>'">
<div class="card text-center" style="width: 18rem;">
  <img src="<?php echo 'admin/'.$blogs_cards['thumbnail']?>" class="card-img-top" alt="blog_img">
  <div class="card-body">
