...
<body>
  ...
  <div class="card-body text-center">
    ...
    <p class="card-text">We develop all kind of websites.Our team work with clients all over world.To accelerate your 
  ...
  <div class="card-body text-center ">
    ...
    <p class="card-text"> We optimize your website's meta tags, headings, content, and other on-page elements to make it search engine friendly and improve
  ...
  <div class="card-body text-center">
    ...
    <p class="card-text"> we offer a wide range of services designed to drive targeted traffic, increase brand visibility, and generate measurable results.</p>
    <a href="contact.php" class="btn btn-outline-dark">Contact Us</a>
  </div>
</div>
    </div>
...
<div class="container mt-5 ">
    ...
    <div class="card-body text-center">
      ...
      <p class="card-text">we are passionate about crafting high-quality, captivating content that drives results.</p>
    ...
    <div class="card-body text-center">
      ...
      <p class="card-text"> We create unique and memorable brand identities that reflect your brand values, personality,
    ...
    <div class="card-body text-center">
      ...
      <p class="card-text">Our user research and analysis help us create designs that are intuitive,
  ...
  <div class="container mt-5 ">
    ...
    <div class="card-body text-center">
      ...
      <p class="card-text">we specialize in creating high-quality, customized WordPress websites that help businesses succeed online.</p>
      <a href="contact.php" class="btn btn-outline-dark mt-4">Contact Us</a>
    </div>
  </div> 
      </div>
    ...
    <div class="card-body text-center">
      ...
      <p class="card-text">we provide professional data entry services to help businesses streamline their data management processes and ensure data accuracy.</p>
      <a href="contact.php" class="btn btn-outline-dark">Contact Us</a>
    </div>
  </div>
      </div>
    ...
    <div class="card-body text-center">
      ...
      <p class="card-text">we specialize in creating cutting-edge .NET applications that help businesses thrive in the digital era.</p>
      <a href="contact.php" class="btn btn-outline-dark mt-4">Contact Us</a>
    </div>
  </div>
      </div>
