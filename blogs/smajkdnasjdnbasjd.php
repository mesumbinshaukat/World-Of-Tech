...
<head>
    <title>smajkdnasjdnbasjd</title>
    <meta charset='UTF-8'>
    <meta name='viewport' content=' width=device-width, initial-scale=1'>
    <meta name='keywords' content=''>
        <meta name='description' content='udshafuishdfushdfuhsdufi'>
...
<input type='hidden' id='blog_id' value='14'>
    ...
    <div class='blog_details section'>
        ...
        <div class='title_and_category'>
            ...
            <h2 class='mx-2 mb-4 fs-1 fw-bolder text-center text-uppercase'> smajkdnasjdnbasjd </h2>
        </div>
        <!-- intro and thumbnail  -->
        <div class='row'>
            ...
            <div class='intro col-lg-12 '>
                <h5 class='text-center fs-3 fst-italic mx-2 mt-4 mb-4 '> dsfnsdhnfuidsfh </h5>
                <h6 class='text-center mx-2 mt-2 mb-4 fw-normal fs-5'> fmijsodjnfisfjisdfjsodf </h6>
                    <img src='../blog_images/../blog_images/front-end-development.jpg' class='image w-50 mx-auto d-block' alt='intro image'>
            </div>
        </div>
        <!-- main section -->
        <div class='main_section'>
            <p class='mx-2 mt-3 mb-4 fs-5 text-center'> sadnuiashduasghdauhd </p>
        ...
        <div class='conclusion_section mb-3'>
            <p class='mx-2 mt-3 mb-3 fs-5 text-center'> sadnuiasnduasnhdu9ashdsuadh </p>

                <img src='../blog_images/../blog_images/web-hosting.jpg ' class='image w-50 mx-auto d-block' alt='end image'>
...
<section id ='comment_section' class='container mt-5'>
        ...
        <input type='hidden' value='14' id='hidden_id'>
    <div id='ID_div'> </div>
    </section>
