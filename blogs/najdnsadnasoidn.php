...
<head>
    <title>najdnsadnasoidn</title>
    <meta charset='UTF-8'>
    <meta name='viewport' content=' width=device-width, initial-scale=1'>
    <meta name='keywords' content=''>
        <meta name='description' content='jfidjnfiosfsfd'>
...
<input type='hidden' id='blog_id' value='13'>

    <!-- blog section starts -->
    <div class='blog_details section'>
        <!-- title and category -->
        <div class='title_and_category'>
            <p class='text-center mx-2 mt-2 '> 2023-05-17 <a
                    class='text-secondary text-decoration-none' href='blog.php'>  </a></p>
            <h2 class='mx-2 mb-4 fs-1 fw-bolder text-center text-uppercase'> najdnsadnasoidn </h2>
        </div>
        <!-- intro and thumbnail  -->
        <div class='row'>
            ...
            <div class='card w-75' id='card'>
                    <img src='../blog_images/../blog_images/Card Details.PNG '
                        class='image' alt='thumbnail'>
                </div>
            </div>

            <div class='intro col-lg-12 '>
                <h5 class='text-center fs-3 fst-italic mx-2 mt-4 mb-4 '> nidkjsmafijsdif </h5>
                <h6 class='text-center mx-2 mt-2 mb-4 fw-normal fs-5'> ojmiojfisjdfiojf </h6>
                    <img src='../blog_images/../blog_images/Domain Pricing 3.PNG' class='image w-50 mx-auto d-block' alt='intro image'>
            </div>
        </div>
        <!-- main section -->
        <div class='main_section'>
            <p class='mx-2 mt-3 mb-4 fs-5 text-center'> dfksdfjsiodfjsf </p>

                <img src='../blog_images/../blog_images/Capture1123.PNG' class='image w-50 mx-auto d-block' alt='main image of paragraph'>

        </div>
        <div class='conclusion_section mb-3'>
            <p class='mx-2 mt-3 mb-3 fs-5 text-center'> sajdmioajdijsadpoasd </p>

                <img src='../blog_images/../blog_images/Error Database.PNG ' class='image w-50 mx-auto d-block' alt='end image'>
...
<section id ='comment_section' class='container mt-5'>
        ...
        <input type='hidden' value='13' id='hidden_id'>
    <div id='ID_div'> </div>
    </section>
