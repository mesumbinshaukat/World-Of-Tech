...
<div class='container-fluid pt-3'>
    ...
    <div class='blog_details section'>
        ...
        <div class='title_and_category'>
            <p class='text-left mx-2 mt-2 '> 2023-04-16 / <a
                    class='text-secondary text-decoration-none' href='blog.php'> Tech </a></p>
            <h2 class='text-left mx-2 mb-3'> Hello World </h2>
        </div>
        <!-- intro and thumbnail  -->
        <div class='row'>
            ...
            <div class='col-lg-12 col-md-12 col-sm-12'>
                <div class='card' id='card'>
                    <img src='../blog_images/../blog_images/Capture1123.PNG ' data-bs-toggle=' modal' data-bs-target='#staticBackdrop'
            ...
            <div class='intro col-lg-12 d-flex flex-column align-self-center'>
                ...
                <h5 class='text-left mx-2 mt-2 mb-3'> sokrpokgpekg </h5>
                <h2 class='text-left mx-2 mt-3 mb-1'>Introduction</h2>
                <h6 class='text-left mx-2 mt-2 mb-3'> gegregregregreg </h6>
                <div class='card' id='card'>
                    <img src='../blog_images/../blog_images/Filezilla For GCP Webhosting.PNG' class='image w-25' alt='intro image'>
                </div>
            </div>
        </div>
        <!-- main section -->
        <div class='main_section'>
            ...
            <p class='text-left mx-2 mt-3 mb-3'> fgfdhsyeutk </p>
            <div class='card' id='card'>
                <img src='../blog_images/../blog_images/Phpmyadmin table-admin-details.PNG' class='image w-25' alt='main image of paragraph'>
            </div>
        </div>
        <div class='conclusion_section mb-5'>
            <h2 class='text-left mx-2 mt-3 mb-1'>Conclusion</h2>
            <p class='text-left mx-2 mt-3 mb-3'> wetretertert </p>
            <div class='card' id='card'>
                <img src='../blog_images/../blog_images/Capture1111.PNG ' class=' image w-25' alt='end image'>
            </div>
        </div>
...
<div class='modal fade' id='staticBackdrop' data-bs-backdrop='static' data-bs-keyboard='false' tabindex='-1'
    ...
    <div class='modal-dialog'>
        <div class='modal-content'>
            ...
            <div class='modal-body'> <img src='../../blog_images/Capture1123.PNG ' class=' img_modal' alt=''>
            </div>
