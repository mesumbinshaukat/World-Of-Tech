      ...
      <input type='hidden' id='blog_id' value=''>
          ...
          <div class='blog_details section'>
              ...
              <div class='title_and_category'>
                  ...
                  <h2 class='mx-2 mb-4 fs-1 fw-bolder text-center text-uppercase'>  </h2>
              </div>
              <!-- intro and thumbnail  -->
              <div class='udp1'>
                  ...
                  <div class='intro col-lg-12 '>
                      <h5 class='text-center fs-3 fst-italic mx-2 mt-4 mb-4 '>  </h5>
                      <h6 class='text-center mx-2 mt-2 mb-4 fw-normal fs-5'>  </h6>
                          <img src='../blog_images/' class='image w-50 mx-auto d-block' alt='intro image'>
                  </div>
              </div>
              <!-- main section -->
              <div class='main_section'>
                  <p class='mx-2 mt-3 mb-4 fs-5 text-center'>  </p>
                      ...
                      <img src='../blog_images/' class='image w-50 mx-auto d-block' alt='main image of paragraph'>
      
              </div>
              <div class='conclusion_section mb-3'>
                  <p class='mx-2 mt-3 mb-3 fs-5 text-center'>  </p>
      
                      <img src='../blog_images/ ' class='image w-50 mx-auto d-block' alt='end image'>
