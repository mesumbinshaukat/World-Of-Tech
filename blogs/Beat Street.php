...
<input type='hidden' id='blog_id' value='1'>
    ...
    <div class='blog_details section'>
        ...
        <div class='title_and_category'>
            <p class='text-center mx-2 mt-2 '> 0000-00-00 / <a
                    class='text-secondary text-decoration-none' href='blog.php'> Tech </a></p>
            <h2 class='mx-2 mb-4 fs-1 fw-bolder text-center text-uppercase'> Beat Street </h2>
        </div>
        <!-- intro and thumbnail  -->
        <div class='row'>
            ...
            <div class='card w-75' id='card'>
                    <img src='../blog_images/../blog_images/beat street logo.png ' 
                        class='image' alt='thumbnail'>
                </div>
            </div>

            <div class='intro col-lg-12 '>
                <h5 class='text-center fs-3 fst-italic mx-2 mt-4 mb-4 '> good music website </h5>
                <h6 class='text-center mx-2 mt-2 mb-4 fw-normal fs-5'>  </h6>
                    <img src='../blog_images/../blog_images/' class='image w-25 mx-auto d-block' alt='intro image'>
            </div>
        </div>
        <!-- main section -->
        <div class='main_section'>
            <p class='mx-2 mt-3 mb-4 fs-5 text-center'>  </p>
        ...
        <div class='conclusion_section mb-3'>
            <p class='mx-2 mt-3 mb-3 fs-5 text-center'>  </p>
...
<section id ='comment_section' class='container mt-5'>
        ...
        <textarea id='ID_commentarea' class='form-control' placeholder='Enter Your Comment' rows='3'></textarea>
