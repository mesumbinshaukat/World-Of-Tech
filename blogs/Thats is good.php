...
<input type='hidden' id='blog_id' value='2'>
    ...
    <div class='blog_details section'>
        ...
        <div class='title_and_category'>
            ...
            <h2 class='mx-2 mb-4 fs-1 fw-bolder text-center text-uppercase'> Thats is good </h2>
        </div>
        <!-- intro and thumbnail  -->
        <div class='row'>
            ...
            <div class='intro col-lg-12 '>
                <h5 class='text-center fs-3 fst-italic mx-2 mt-4 mb-4 '> LOL </h5>
