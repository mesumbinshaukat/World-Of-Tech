...
<body>
    ...
    <section id="main_blog_active">
        <button type="button" class="btn_menu float-end pb-2 pe-3 mt-3" onclick="btn_menu()"><img src="./icons/list.png" width="25px" alt=""></button>
        
        <section id="category_wise" class=" d-flex flex-column  justify-content-center align-items-center mt-5 pt-5 pb-5 ">
            <p class="mb-3 pt-3 fs-2">Blogs</p>
            <p class="mb-2 fs-5">Catgeories</p>
            <div class="blog_categories pb-3">
                
                <input type="button" class="cat_btn p-2" onclick="myFunction('Tech')" value="Tech">
                <input type="button" class="cat_btn p-2" onclick="myFunction('Sports')" value="Sports">
                <input type="button" class="cat_btn p-2" onclick="allFunction()" value="All">
...
<div class="col-lg-4 col-md-6 col-sm-12 mb-4 d-flex justify-content-center text-center">    
    <div class="items">
        <a class="text-decoration-none text-dark" href="blogdetails.php?id='<?php echo $fetching_all['id']?>'">
            <div class="card" style="width: 18rem;">
                <img src="<?php echo 'admin/'.$fetching_all['thumbnail']?>" class="card-img-top" width="250px" alt="blog_img">
                <div class="card-body">
...
<button type="button" class="btn_menu float-end pb-2 pe-3 mt-3" onclick="btn_menu1()"><img src="./icons/menu.png" width="25px" alt=""></button>
