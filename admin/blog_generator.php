...
$fetch_query = "SELECT * FROM `admin_blogs` WHERE id = 2";
...
<div class='container-fluid pt-3'>
    ...
    <div class='blog_details section'>
        ...
        <div class='title_and_category'>
            <p class='text-left mx-2 mt-2 '> " . $row['publish_date'] . " / <a class='text-secondary text-decoration-none'
                    href='blog.php'> " . $row['blog_category'] . " </a></p>
        ...
        <div class='row'>
            ...
            <div class='col-lg-12 col-md-12 col-sm-12'>
                <div class='card' id='card'>
                    <img src='../".$row['thumbnail'] . " ' data-bs-toggle=' modal' data-bs-target='#staticBackdrop'
            ...
            <div class='intro col-lg-12 d-flex flex-column align-self-center'>
                ...
                <div class='card' id='card'>
                    <img src='../".$row['intro_img'] . "' class='image w-25' alt='intro image'>
                </div>
            </div>
        </div>
        <!-- main section -->
        <div class='main_section'>
            ...
            <div class='card' id='card'>
                <img src='../".$row['main_img'] . "' class='image w-25' alt='main image of paragraph'>
            </div>
        </div>
        <div class='conclusion_section mb-5'>
            ...
            <div class='card' id='card'>
                <img src='../".$row['conclusion_img'] . " ' class=' image w-25' alt='end image'>
            </div>
        </div>
