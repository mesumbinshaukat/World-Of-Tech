...
while ($row = mysqli_fetch_array($fetch_query_run)) {
  ...
  <h4> " . $row['subtitle'] . "</h4>
  <figure >
    <img src='../blog_images/" . $row['thumbnail'] . " ' alt='thumbnail'>
    </figure>
  <p>" . $row['intro_para'] . "</p>
  <figure >
    <img src='../blog_images/" . $row['intro_img'] . " ' alt='intro image'>
    </figure>
  <p> " . $row['main_para'] . " </p>
  
  <figure>
  <img src='../blog_images/" . $row['main_img'] . "' alt='main image of paragraph'>
  </figure>
  <h3>Conclusion</h3>
  <p>" . $row['conclusion_para'] . "</p>
  <figure>
  <img src='../blog_images/" . $row['conclusion_img'] . " ' alt='end image'>
  </figure>
