...
<body>
    ...
    <div class="title_and_category">
        <p class="text-left mx-2 mt-2 "><?php echo $blogs_details['publish_date']?> / <a class="text-secondary text-decoration-none" href="blog.php"><?php echo $blogs_details['blog_category']?></a></p>
    <h2 class="text-left mx-2 mb-3"><?php echo $blogs_details['blogtitle']?></h2>
        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">        
                ...
                <img src="<?php echo 'admin/'.$blogs_details['thumbnail']?>" data-bs-toggle="modal" data-bs-target="#staticBackdrop"  class="image w-50" alt="">
                </div>
            </div>
            ...
            <div class="intro col-lg-12 d-flex flex-column align-self-center">         
                ...
                <div class="card" id="card">
                    <img src="<?php echo 'admin/'.$blogs_details['intro_img']?>" class="image w-25" alt="">
                </div>
            </div>
         </div>
         <!-- main section -->
        <div class="main_section">
           ...
           <div class="card" id="card">
                <img src="<?php echo 'admin/'.$blogs_details['main_img']?>" class="image w-25" alt="">
           </div>
        </div>
           ...
           <p class="text-left mx-2 mt-3 mb-3"><?php echo $blogs_details['conclusion_para']?></p>
            <div class="card" id="card" >
                <img src="<?php echo 'admin/'. $blogs_details['conclusion_img']?>" class="image w-25" alt="">
            </div>
           </div>
